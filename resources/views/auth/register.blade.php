    ...
    <div class="flex justify-center">
        <div class="w-4/12 bg-white p-6 rounded-lg">
            <form action="{{ route('register') }}" method="post">
                @csrf
                <div class="mb-4">
                    <p class="text-center font-medium text-xl">Register</p>
                </div>
                ...
                <div class="mb-4">
                    ...
                    {{-- also learned how to add error styling --}}

                    {{-- if we have any err with the name then the in between code will be executed --}}
                    @error('name')
